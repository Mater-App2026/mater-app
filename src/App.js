  ...
  async function toggleReminder() {
    if (!reminderEnabled) {
      ...
      if (granted) {
        ...
        setReminderStatus("✓ Recordatorio activado");
      } else {
        setReminderStatus("Permiso denegado. Actívalo en la configuración del navegador.");
      }
    } else {
    ...
    <div style={{ flex: 1, overflowY: "auto", background: gradients.home, paddingBottom: 90 }}>
      {remindOpen && (
        <div style={sheetOverlay} onClick={() => setRemindOpen(false)}>
          <div onClick={e => e.stopPropagation()} style={sheetCard()}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontSize: 18, fontWeight: 800, color: C.ink, margin: 0 }}>🔔 Recordatorio diario</h2>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: C.iceBlue, borderRadius: 14, padding: "14px 16px", marginBottom: 16 }}>
              <div>
                <p style={{ fontSize: 13, fontWeight: 700, color: C.ink, margin: 0 }}>Activar recordatorio</p>
                <p style={{ fontSize: 11, color: C.slateLight, margin: "2px 0 0" }}>Un aviso al día para revisar tu Horario</p>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 13, color: C.ink }}>Hora del recordatorio</span>
            ...
            <p style={{ fontSize: 11, color: C.slateLight, marginTop: 20, lineHeight: 1.6, textAlign: "center" }}>En iPhone, instala Mater en tu pantalla de inicio para recibir notificaciones.</p>
          </div>
        </div>
      )}
      ...
      <div style={{ padding: "52px 22px 8px", display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontSize: 12, color: C.slateLight, margin: "0 0 2px", letterSpacing: "0.08em", textTransform: "uppercase" }}>Más</p>
          <h2 style={{ fontSize: 20, fontWeight: 600, color: C.ink, margin: 0, fontFamily: "'Cormorant Garamond', serif" }}>Horario Espiritual</h2>
        </div>
      ...
      {loading ? (
        <p style={{ textAlign: "center", color: C.slateLight, fontSize: 13, marginTop: 32 }}>Cargando tu Horario...</p>
      ) : (
        <>
