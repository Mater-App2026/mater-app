...
function HomeScreen({ user, profile, onTabChange }) {
  ...
  function getStaticPracticeContent(index) {
    ...
    const laudesContent = [
      { santo: "San Juan de la Cruz", cita: "«En el principio de la mañana, consagra a Dios el primer movimiento del corazón.»", reflexion: "Los Laudes — la oración de la mañana de la Iglesia — son una declaración teológica: antes de que el mundo me reclame, yo me pertenezco a Dios.\n\nSan Benito enseñaba que la primera obra del monje cada mañana debía ser la oración, no porque Dios la necesite, sino porque el alma la necesita. La persona que ora en la mañana lleva consigo durante el día una quietud interior que no depende de las circunstancias.\n\nSanta Teresa de Ávila llamaba a esto 'el punto de Arquímedes del alma' — ese punto fijo desde el cual todo lo demás encuentra su lugar. Cuando comenzamos el día anclados en Dios, los problemas no desaparecen, pero adquieren proporciones diferentes.\n\nHoy, antes de revisar el teléfono, dedica estos minutos a consagrar el día a Dios. San Juan Vianney decía que bastaba con 'mirar a Dios y dejar que Dios te mire.'", preguntas: ["¿Cómo llego a este nuevo día — con gratitud, con ansiedad, con prisa?", "¿Hay algo que quiero entregar específicamente a Dios esta mañana?", "¿Qué gracia concreta necesito hoy?"] },
      { santo: "San Francisco de Asís", cita: "«Comienza cada día como si fuera el primero — y el último.»", reflexion: "San Francisco de Asís tenía la costumbre de saludar cada amanecer como si fuera la primera vez que veía el sol. Para él, no había amaneceres repetidos — cada uno era un regalo único, irrepetible, sagrado.\n\nEsta actitud ante la mañana no es ingenuidad espiritual — es sabiduría profunda. El día que comienza nunca ha existido antes. Las personas que encontrarás hoy, las conversaciones, las decisiones — todo es nuevo. Todo merece atención fresca.\n\nLa oración de la mañana nos entrena en esta mirada. Antes de que la rutina nos anestesie, nos detenemos un momento para recordar: este día es un don. No lo merezco, no lo gané, no lo produje — me fue dado.\n\nHoy, al abrir los ojos, di gracias antes de hacer nada. Ese instante de gratitud puede cambiar el tono de todo lo que viene después.", preguntas: ["¿Qué tiene de único este día — qué no se repetirá jamás?", "¿Cómo sería vivir hoy con la actitud de Francisco ante el amanecer?", "¿A quién o qué quieres darle atención fresca hoy?"] },
      { santo: "Santa Teresa de Ávila", cita: "«La oración de la mañana es el timón que dirige el barco del día.»", reflexion: "Santa Teresa de Ávila llegó a la oración de madurez después de muchos años de lucha. Durante casi veinte años, la oración fue para ella un campo de batalla. Y sin embargo, no la abandonó.\n\nLo que la mantuvo fue una convicción que fue creciendo despacio: la oración no depende de cómo me siento. Hay días en que la oración de la mañana es luminosa, y días en que es árida y difícil. En ambos casos, el gesto de presentarse ante Dios tiene un valor que no depende de la experiencia.\n\nTeresa comparaba la oración de la mañana con el timón de un barco. No importa si el mar está calmo o agitado — el timón determina hacia dónde vas. La oración del comienzo del día orienta la dirección interior de todo lo que viene después.\n\nHoy, ora aunque no tengas ganas. El mérito más grande de la oración no es la consolación que produce, sino la fidelidad que expresa.", preguntas: ["¿Tienes la tentación de saltarte la oración cuando no tienes ganas — y qué pasa cuando lo haces?", "¿Qué diferencia notas en los días que comienzas con oración y los que no?", "¿Cómo puedes hacer más estable tu oración de la mañana?"] },
      { santo: "San Ignacio de Loyola", cita: "«Ofrece al Señor la primera hora del día, antes de que el mundo reclame la primera palabra.»", reflexion: "San Ignacio de Loyola estructuró sus Ejercicios Espirituales con una lógica precisa: primero la oración, luego la actividad. No porque la actividad sea menos importante, sino porque la calidad de la actividad depende de la calidad de la oración que la precede.\n\nEn la espiritualidad ignaciana, la oración de la mañana no es un ritual de cumplimiento — es una toma de posición interior. Es decidir, antes de que el día comience, desde dónde vas a vivir: desde el miedo o desde la confianza, desde el ego o desde Dios.\n\nIgnacio proponía comenzar cada día recordando la presencia de Dios. No como una idea abstracta sino como una realidad concreta: Dios está aquí, en este cuarto, en este momento, mirándome con amor.\n\nHoy, antes de levantarte, quédate un instante en esa presencia. Que las primeras palabras que digas sean para Él.", preguntas: ["¿Desde dónde quieres vivir este día — qué actitud quieres que lo guíe?", "¿Cómo sería tu día si realmente sintieras que Dios está contigo en cada momento?", "¿Qué le quieres pedir a Dios específicamente para las próximas horas?"] },
      { santo: "San Juan Pablo II", cita: "«El día comienza y termina en Dios — todo lo demás es el camino entre esos dos puntos.»", reflexion: "San Juan Pablo II tenía la costumbre de pasar la primera hora de cada día en oración, incluso en los períodos más intensos de su pontificado. Sus secretarios contaban que ninguna reunión, ningún viaje, ninguna urgencia podía moverlo de ese tiempo de oración matutina.\n\nNo era rigidez — era sabiduría. Juan Pablo II sabía que la fuente de su energía, su claridad y su capacidad de amar no venía de él mismo. Venía de esa hora silenciosa al comienzodel día, en la capilla privada, ante el Santísimo.\n\nLo que sostuvo un pontificado de 27 años, marcado por el sufrimiento y la alegría, fue precisamente esa fidelidad a la oración de la mañana. No hay actividad tan urgente que justifique saltar ese encuentro.\n\nHoy, da a Dios la primera hora — o los primeros minutos, si es todo lo que tienes. Es suficiente. Él hace mucho con poco.", preguntas: ["¿Cuánto tiempo real le das a Dios en la mañana — y estás satisfecho con eso?", "¿Qué tendrías que reorganizar para proteger mejor ese tiempo de oración matutina?", "¿Qué pasa en tu interior cuando cuidas bien la oración del comienzo del día?"] },
      { santo: "Santa Faustina Kowalska", cita: "«Cada mañana es una nueva misericordia — recíbela con corazón abierto.»", reflexion: "Santa Faustina Kowalska vivió la oración de la mañana como un encuentro con la Misericordia Divina. Para ella, cada amanecer no era simplemente un nuevo día — era una nueva oportunidad de recibir el amor de Dios, fresco y renovado.\n\nEn su Diario, Faustina escribe sobre cómo comenzaba cada día ofreciendo sus sufrimientos y alegrías a Dios, pidiéndole que los usara para la salvación de las almas. Esta actitud transformó incluso los días más difíciles en actos de amor.\n\nLa misericordia de Dios es nueva cada mañana — así lo cantaba el profeta Jeremías. No es una misericordia gastada por el uso ni agotada por nuestros fracasos. Es siempre fresca, siempre abundante, siempre mayor que nuestras faltas.\n\nHoy, recibe la mañana como un regalo de la Misericordia Divina. Y ofrece el día entero — lo bueno y lo difícil — como respuesta a ese amor.", preguntas: ["¿Cómo cambia tu mañana cuando la recibes como misericordia nueva?", "¿Hay algo de ayer que necesitas dejar atrás para comenzar este día libre?", "¿Qué quieres ofrecerle a Dios de este día que comienza?"] },
      { santo: "San Benito de Nursia", cita: "«Ora et labora — pero siempre el ora primero.»", reflexion: "San Benito de Nursia organizó la vida monástica alrededor del principio del Opus Dei — la Obra de Dios. Para él, la oración no era una actividad entre otras: era la actividad que daba sentido a todas las demás.\n\nLos monjes benedictinos se levantan antes del amanecer para los Maitines — la primera oración del día, cuando el mundo todavía duerme. No es masoquismo espiritual: es la convicción de que hay algo que merece ser lo primero.\n\nEn el mundo contemporáneo, esta lógica parece contracultural. Primero el trabajo, primero las notificaciones, primero el café. Pero San Benito nos recuerda que lo que pones primero revela lo que más valoras.\n\nHoy, que la oración sea lo primero — aunque sea breve. Ese gesto simple dice más sobre tus prioridades que cualquier lista de valores.", preguntas: ["¿Qué es lo primero que haces cada mañana — y qué dice eso sobre tus prioridades?", "¿Cómo podrías integrar una pequeña oración al comienzo del día sin que sea una carga?", "¿Qué encontrarías si le dieras a Dios los primeros minutos de cada mañana durante un mes?"] },
    ];
